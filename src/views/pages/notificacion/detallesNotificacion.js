      ...
      <CRow className="justify-content-center">
        <CCol md={8}>
          <CCard className="p-4">
            ...
            <CCardBody>
              <p><strong>Razón de Solicitud: </strong>{solicitud.motivo_reserva}</p>
              <p><strong>Ambiente: </strong>{nombreAula}</p> {/* Mostrar el nombre del aula */}
              <div className="row">
                <div className="col-auto">
                  <p><strong>Materia: </strong>{nombreMateria}</p> {/* Mostrar el nombre de la materia */}
                </div>
                {/*
                <div className="col-auto">
              ...
              <p><strong>Fecha de Reserva: </strong>{solicitud.fecha_hora_reserva}</p>
